...
export default function Card({ card, index, handleDelete }) {
	...
	return (
		<div className="relative flex justify-center perspective-1000">
			<div
				className={`card w-full h-52 sm:h-64 shadow-xl cursor-pointer transition-all duration-500 
			...
			>
				...
				<div className="absolute w-full h-full backface-hidden rotate-y-180">
					<div className="card-body flex flex-col justify-between h-full bg-primary text-secondary-content rounded-xl p-6">
