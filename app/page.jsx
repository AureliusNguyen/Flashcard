      ...
      <div className="hero min-h-screen bg-base-200">
        <div className="hero-content text-center">
          <div className="max-w-md">
            <h1 className="text-5xl font-bold">Welcome to Flashcard Generator</h1>
            <p className="py-6">Generate and study flashcards with ease. Choose a plan that suits your needs and start learning today!</p>
